...
#include "../external/cglm/include/cglm/struct/mat4.h"
...
namespace raptor {
    ...
    struct Camera {
        ...
        void init_perspective ( f32 near_plane, f32 far_plane, f32 fov_y, f32 aspect_ration );
        void init_orthographic( f32 near_plane, f32 far_plane, f32 viewport_width, f32 viewport_height, f32 zoom );

        void reset();

        void set_viewport_size( f32 witdht, f32 height );
        void set_zoom( f32 zoom );
        void set_aspect_ratio( f32 aspect_ration );
